# Comparing `tmp/stackviz-0.0.7.tar.gz` & `tmp/stackviz-0.0.8.tar.gz`
...
## Comparing `stackviz-0.0.7.tar` & `stackviz-0.0.8.tar`
...
### Comparing `stackviz-0.0.7/LICENSE` & `stackviz-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `stackviz-0.0.7/stackviz/display/chart.py` & `stackviz-0.0.8/stackviz/display/chart.py`

 * *Files identical despite different names*

### Comparing `stackviz-0.0.7/stackviz/display/layout.py` & `stackviz-0.0.8/stackviz/display/layout.py`

 * *Files identical despite different names*

### Comparing `stackviz-0.0.7/stackviz/display/stack.py` & `stackviz-0.0.8/stackviz/display/stack.py`
