# Comparing `tmp/tgwrap-0.7.6.tar.gz` & `tmp/tgwrap-0.7.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tgwrap-0.7.6.tar", max compression
+gzip compressed data, was "tgwrap-0.7.7.tar", max compression
```

## Comparing `tgwrap-0.7.6.tar` & `tgwrap-0.7.7.tar`

### file list

```diff
@@ -1,10 +1,10 @@
--rw-r--r--   0        0        0     1065 2022-12-25 10:02:18.884994 tgwrap-0.7.6/LICENSE
--rw-r--r--   0        0        0     8381 2023-06-21 12:44:31.502352 tgwrap-0.7.6/README.md
--rw-r--r--   0        0        0      902 2023-07-07 12:33:21.374627 tgwrap-0.7.6/pyproject.toml
--rw-r--r--   0        0        0        0 2022-12-26 11:59:24.403826 tgwrap-0.7.6/tgwrap/__init__.py
--rw-r--r--   0        0        0     9164 2023-05-26 12:32:25.245403 tgwrap-0.7.6/tgwrap/analyze.py
--rwxr-xr-x   0        0        0    26583 2023-07-07 08:50:53.225395 tgwrap-0.7.6/tgwrap/cli.py
--rwxr-xr-x   0        0        0    66775 2023-07-07 12:32:56.057571 tgwrap-0.7.6/tgwrap/main.py
--rw-r--r--   0        0        0     2663 2023-01-16 19:18:54.217701 tgwrap-0.7.6/tgwrap/printer.py
--rw-r--r--   0        0        0     9561 1970-01-01 00:00:00.000000 tgwrap-0.7.6/setup.py
--rw-r--r--   0        0        0     9464 1970-01-01 00:00:00.000000 tgwrap-0.7.6/PKG-INFO
...
### Comparing `tgwrap-0.7.6/LICENSE` & `tgwrap-0.7.7/LICENSE`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/README.md` & `tgwrap-0.7.7/README.md`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/pyproject.toml` & `tgwrap-0.7.7/pyproject.toml`
...
### Comparing `tgwrap-0.7.6/tgwrap/analyze.py` & `tgwrap-0.7.7/tgwrap/analyze.py`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/tgwrap/cli.py` & `tgwrap-0.7.7/tgwrap/cli.py`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/tgwrap/main.py` & `tgwrap-0.7.7/tgwrap/main.py`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/tgwrap/printer.py` & `tgwrap-0.7.7/tgwrap/printer.py`

 * *Files identical despite different names*

### Comparing `tgwrap-0.7.6/setup.py` & `tgwrap-0.7.7/setup.py`
...
### Comparing `tgwrap-0.7.6/PKG-INFO` & `tgwrap-0.7.7/PKG-INFO`
