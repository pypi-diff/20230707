# Comparing `tmp/bchmnn.poodle-0.0.7.tar.gz` & `tmp/bchmnn.poodle-0.0.8.tar.gz`
...
### Comparing `bchmnn.poodle-0.0.7/src/poodle/corews.py` & `bchmnn.poodle-0.0.8/src/poodle/corews.py`
