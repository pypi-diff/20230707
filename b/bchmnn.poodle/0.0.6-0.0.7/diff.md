# Comparing `tmp/bchmnn.poodle-0.0.6.tar.gz` & `tmp/bchmnn.poodle-0.0.7.tar.gz`
...
### Comparing `bchmnn.poodle-0.0.6/src/bchmnn.poodle.egg-info/SOURCES.txt` & `bchmnn.poodle-0.0.7/src/bchmnn.poodle.egg-info/SOURCES.txt`
